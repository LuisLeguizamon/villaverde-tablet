...
import com.example.luis.villaverde_tablet.dummy.DummyContent;

import java.util.List;

/**
 * An activity representing a list of Formularios. This activity
 * has different presentations for handset and tablet-size devices. On
 * handsets, the activity presents a list of items, which when touched,
 * lead to a {@link FormularioDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 */
public class FormularioListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.formulario_detail_container) != null) {
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        intent.putExtra(FormularioDetailFragment.ARG_ITEM_ID, holder.mItem.id);
